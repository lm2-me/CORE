...
'''
DEPRECATED since release of multicore_v2
'''
...
def main():
    ...
    edges = City.nearest_edges(5, cpus=None)
    ...
    print('------------------------------------')
    start = time.time()
    paths = City._shortest_paths(orig_yx_transf, dest_yx_transf, orig_edge, dest_edge, weight='travel_time', method='dijkstra', return_path=True, cpus=None)
    end = time.time()
