...
class CityNetwork():
    ...
    def format_boundary_coordinates(self):
        coordinates_list = coordinates_to_tupple(self.coordinates)
        ...
        coordinates = flip_lat_long(coordinates_transformed_yx)
        return coordinates
    ...
    def load_origins(self):
        ...
        origins = []
        for _, row in self.building_addr_df.iterrows():
